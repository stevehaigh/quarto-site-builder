...
#
# Outputs land in _site/decks/llm-intro/ alongside the rendered HTML.
...
DECK_DIR="$REPO_ROOT/_site/decks/llm-intro"
DECK_SRC_DIR="$REPO_ROOT/decks/llm-intro"
DECK_SRC="decks/llm-intro/index.qmd"
