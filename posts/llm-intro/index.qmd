...
The deck is built with Quarto reveal.js from the same template I [wrote up the other week](../academic-pptx-template/). PDF and PPTX downloads are linked from the [Projects & Decks page](../../projects.html#slide-decks).
